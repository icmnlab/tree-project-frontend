...
![Version](https://img.shields.io/badge/version-18.10.4%2B26-blue)
...
**Documentation hub**: [`docs/README.md`](docs/README.md) — architecture, API catalog, database schema, deployment runbooks, and module guides (canonical copy; backend repo links here).
...
MIT — see `LICENSE`. Original development and primary maintenance by **KyleliuNDHU**; see `AUTHORS.md` and `docs/HANDOFF.md` §0.
