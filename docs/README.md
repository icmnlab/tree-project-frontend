...
2. [`HANDOFF_SECRETS_CHECKLIST.md`](HANDOFF_SECRETS_CHECKLIST.md) — 哪些不能進 Git、要怎麼備份
3. [`DEVELOPMENT_BACKLOG.md`](DEVELOPMENT_BACKLOG.md) — 已完成與暫緩項目
4. [`FIELD_SURVEY_SOP.md`](FIELD_SURVEY_SOP.md) — 給現場調查員（非技術）
5. [`MEETING_MINUTES_20260528.md`](MEETING_MINUTES_20260528.md) — 需求與決議來源
