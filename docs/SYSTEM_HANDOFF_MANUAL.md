...
| 項目 | 內容 |
|------|------|
| 前端 Repo | https://github.com/<GITHUB_OWNER>/tree-project-frontend |
| 後端 Repo | https://github.com/<GITHUB_OWNER>/tree-project-backend |
...
```bash
git clone https://github.com/<GITHUB_OWNER>/tree-project-frontend.git
...
```dart
baseUrl = 'https://<TAILSCALE_HOST>/api';
```
...
| **GitHub repo 權限** | 原作者帳號 <GITHUB_OWNER> | 加入接手者為 collaborator，或移轉 repo |
