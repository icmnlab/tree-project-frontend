...
// ============================================================================
// ⚠️ 2026-04-26 [T3] DBH 測量校準 UI 已從 v3_services_page.dart 移除。
//    本檔目前無任何 UI / 流程引用，視為待清理孤立碼。
//    暫保留以利 T4（ML data sync）規劃；若 T4 確認不需要 CalibrationData / ML
//    metadata 結構，請整檔刪除（連同 import 與相關測試）。
// ============================================================================
// 採用「兼容式開發」原則：
