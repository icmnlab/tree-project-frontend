      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildStatRow(
                '總年碳吸存量', '${formatStat(carbon['total_annual_carbon'])} 公斤'),
            _buildStatRow(
                '平均年碳吸存量', '${formatStat(carbon['avg_annual_carbon'])} 公斤'),
          ],
        ),
      ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
                '您的樹木每年可吸收約 ${_totalAnnualSequestration.toStringAsFixed(2)} 公斤二氧化碳'),
            Text('總共儲存了 ${_totalCarbonStorage.toStringAsFixed(2)} 公斤二氧化碳'),
          ],
        ),
      ),
    );
