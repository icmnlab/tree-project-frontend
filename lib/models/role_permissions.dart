...
class RolePermissions {
  ...
  static const entries = <RolePermissionEntry>[
    ...
    RolePermissionEntry(
      role: '業務管理員',
      level: 4,
      summary: '負責使用者、邀請碼與跨區資料管理。',
      capabilities: [
        '存取管理後台（使用者、匯出、區管理、維運工具箱）',
        '新增／編輯／停用使用者、指派區權限',
        '建立與停用邀請碼',
        '查看稽核 log、待重設密碼',
        'CSV 匯入',
    ...
    RolePermissionEntry(
      role: '專案管理員',
      level: 3,
      summary: '管理自己負責區的邊界、區域與刪除作業。',
      capabilities: [
        '存取管理後台（依 tab 權限：區邊界繪製）',
        '繪製／更新／刪除區邊界',
        '刪除樹木、匯入樹木檔案',
        '新增／編輯樹木（限已授權區）',
        '查看已授權區資料',
    ...
    RolePermissionEntry(
      role: '調查管理員',
      level: 2,
      summary: '現場調查：新增與編輯樹木、匯入匯出（限已授權區）。',
      capabilities: [
